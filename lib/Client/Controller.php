...
namespace WHMCS\Module\Addon\MurrabatrackingAddonModule\Client;
...
class Controller {
    ...
    public function index($vars)
    {
        ...
        $modulelink = $vars['modulelink']; // eg. murrabatrackingaddonmodule.php?module=murrabatrackingaddonmodule
        ...
        return array(
            ...
            'breadcrumb' => array(
                'index.php?m=murrabatrackingaddonmodule' => 'SuperAdmin Addon Module',
            ),
    ...
    public function secret($vars)
    {
        ...
        return array(
            ...
            'breadcrumb' => array(
                'index.php?m=murrabatrackingaddonmodule' => 'SuperAdmin Addon Module',
                'index.php?m=murrabatrackingaddonmodule&action=secret' => 'Secret Page',
            ),
